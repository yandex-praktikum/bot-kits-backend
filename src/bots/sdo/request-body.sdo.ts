...
const botsDescription: IFieldDescription[] = [
	...
	createField('icon', 'https://cdn.icon-icons.com/icons2/1233/PNG/512/1492718766-vk_83600.png'),
	createField('title', 'Создание заказов', 'string', '', true),
	createField('description', 'Бот для создания заказов'),
	createField('features', ['Создание заказов', 'Редактирование заказов'], 'array'),
